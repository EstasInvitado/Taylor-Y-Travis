  ...
  <div class="paleta-colores">
    ...
    <section class="container" id="confirmar" style="background:linear(#F2EFED, #F2EFED)">
        <div class="container reveal" style="text-align:center">
            ...
            <p>
                <a class="btn whatsapp" href="https://wa.me/526647629596?text=¡Hola!%20Confirmo%20mi%20asistencia%20a%20la%20boda%20de%20Taylor%20y%20Travis.%0ANombre:%20*Agrega%20tu%20nombre*" target="_blank" rel="noreferrer noopener">Confirmar por WhatsApp</a>
            </p>
        </div>
    </section>
